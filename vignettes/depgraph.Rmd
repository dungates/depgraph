...
author: "Mostly @crsh, tiny bit from @dungates"
...
```{r dependency-example, fig.align = "center", fig.height = 5, fig.width = 7, fig.cap = "Dependency graph of a historic development version of the R package `multibridge`.", warning = FALSE}
library(depgraph)
